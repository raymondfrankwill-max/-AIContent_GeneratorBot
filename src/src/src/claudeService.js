...
// System prompts per content type. Keep these short and specific —
// the tone is injected separately so users can control it with /tone.
...
/**
 * Generate content of a given type from a user prompt.
 * @param {'post'|'caption'|'article'|'ideas'} type
 * @param {string} prompt - the user's topic/description
 * @param {string} tone - user's preferred tone
